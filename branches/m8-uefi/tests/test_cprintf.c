...
extern int cprintf( void (*putchar_f)(int,...), void (*putwchar_f)(wchar_t,...), char* putchar_args, const char *fmt, ... );

char local_buf[100];
int  local_wchar_buf[100];
int  bptr, wbptr;

void reset_putchar_bufs( void ) {
    int i;
...
void t_putwchar( wchar_t w, ... ) {
    local_wchar_buf[wbptr++] = (int)w;
}


#define local_printf(format, ...) cprintf(t_putchar, t_putwchar, NULL, format, ## __VA_ARGS__)
...
int main( void ) {
    ...
    reset_putchar_bufs();
    c = cprintf( t_putchar, t_putwchar, NULL, "" );
    ...
    reset_putchar_bufs();
    c = cprintf( t_putchar, t_putwchar, NULL, " abc\t123\nfoo bar" );
    ...
    reset_putchar_bufs();
    c = cprintf( t_putchar, t_putwchar, NULL, "%d", (long)123 );
    ...
    reset_putchar_bufs();
    c = cprintf( t_putchar, t_putwchar, NULL, "%d", -345690 );
    ...
    reset_putchar_bufs();
    c = cprintf( t_putchar, t_putwchar, NULL, "%i", p );
    ...
    reset_putchar_bufs();
    c = cprintf( t_putchar, t_putwchar, NULL, "%x", x );
    ...
    reset_putchar_bufs();
    c = cprintf( t_putchar, t_putwchar, NULL, "%x", (long)-3456789 );
    ...
    reset_putchar_bufs();
    c = cprintf( t_putchar, t_putwchar, NULL, "%s", "this is the %% time\n" );
    ...
    reset_putchar_bufs();
    c = cprintf( t_putchar, t_putwchar, NULL, "1a%%23%i-%x%i,%s\n", -234, x, p, str );
    ...
    reset_putchar_bufs();
    c = cprintf( t_putchar, t_putwchar, NULL, "1a%%23%i-%x%i,%s%d<>%%%x%s%c\n", -234, x, p, "this", 1576342, 0x0, str, 'a' );
    ...
    reset_putchar_bufs();
    c = local_printf( "%ls", L"Long text" );

    fail_unless( s, __wcscmp( (const int*)local_wchar_buf, L"Long text" ) == 0,
                 "To cprintf, long string, buffer is correct" );
    fail_unless( s, c == 9,
                 "To cprintf, long string, count is 9" );

    reset_putchar_bufs();
    c = local_printf( "%s%ls%c%%%i%ls%c\n", "hello", L"goodbye now", 'c', 232, L" everyone", 'C' );

    fail_unless( s, __wcscmp( (const int*)local_wchar_buf, L"goodbye now everyone" ) == 0,
                 "To cprintf, long string mixed with others, wcar buffer is correct" );
    fail_unless( s, __strncmp( (const char*)local_buf, "helloc%232C\n", 100 ) == 0,
                 "To cprintf, long string mixed with others, regular buffer is correct" );
    fail_unless( s, c == 32,
                 "To cprintf, long string, count is 9" );
