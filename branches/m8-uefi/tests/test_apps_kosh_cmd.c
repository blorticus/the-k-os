...
kosh_error cmd1_proc( char32_t** argv, int argc ) {
    cmd_called  = "cmd1";
    called_argv = argv;
    called_argc = argc;
    return KOSH_OK;
...
kosh_error cmd12_proc( char32_t** argv, int argc ) {
    cmd_called  = "cmd12";
    called_argv = argv;
    called_argc = argc;
    return KOSH_OK;
...
kosh_error cmd2_proc( char32_t** argv, int argc ) {
    cmd_called  = "cmd2";
    called_argv = argv;
    called_argc = argc;
    return KOSH_OK;
...
int main( void ) {
    ...
    fail_unless( s, kosh_execute_cmd( &l1, (const char32_t*)L"" ) == KOSH_EMPTY_COMMAND, "kosh_execute_cmd for '' does not return KOSH_EMPTY_COMMAND" );
    ...
    fail_unless( s, kosh_execute_cmd( &l1, (const char32_t*)L"cmd" ) == KOSH_NO_SUCH_COMMAND, "kosh_execute_cmd for 'cmd' does not return KOSH_NO_SUCH_COMMAND" );
    ...
    fail_unless( s, kosh_execute_cmd( &l1, (const char32_t*)L"cmd for me" ) == KOSH_NO_SUCH_COMMAND, "kosh_execute_cmd for 'cmd for me' does not return KOSH_NO_SUCH_COMMAND" );
    ...
    fail_unless( s, kosh_execute_cmd( &l1, (const char32_t*)L"cmd1" ) == KOSH_OK, "kosh_execute_cmd for 'cmd1' does not return KOSH_OK" );
    ...
    fail_unless( s, kosh_execute_cmd( &l1, (const char32_t*)L"cmd13" ) == KOSH_NO_SUCH_COMMAND, "kosh_execute_cmd for 'cmd13' does not return KOSH_NO_SUCH_COMMAND" );
    ...
    fail_unless( s, kosh_execute_cmd( &l1, (const char32_t*)L"cmd12 for the win!" ) == KOSH_OK, "kosh_execute_cmd for 'cmd12 for the win!' does not return KOSH_OK" );
