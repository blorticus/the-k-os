...
Mono8x16SimpleFont::Mono8x16SimpleFont() {
}


void* Mono8x16SimpleFont::bitmapFor( uint32_t codepoint ) {
    if (codepoint > 255)
        return (uint8_t*)0;
    else
        return (void*)&FONT_MAP_8x16[m_char_vrez * codepoint];
}


unsigned int Mono8x16SimpleFont::charHrez() {
    return m_char_hrez;
}


unsigned int Mono8x16SimpleFont::charVrez() {
    return m_char_vrez;
}


unsigned int Mono8x16SimpleFont::hrezEncodingBytes() {
    return 1;
}
